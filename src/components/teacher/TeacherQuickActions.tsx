    ...
    <div className="mb-6 mt-8 grid grid-cols-2 gap-3 px-4">
      {ACTIONS.map(({ label, href, Icon }) => (
        <Link
          key={label}
          href={href}
          className="flex flex-col items-center justify-center rounded-2xl border border-brand-off-white bg-white p-4 text-center shadow-sm transition-colors active:bg-brand-safe-ivory"
        >

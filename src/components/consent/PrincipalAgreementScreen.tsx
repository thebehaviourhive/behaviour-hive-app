...
export function PrincipalAgreementScreen({
  ...
  return (
    ...
    >
      <p>
        You can see every child enrolled at your school and everything recorded about them, and you decide who
        else can.
      </p>
      <p>
        <strong className="font-semibold">Countersigning an incident closes it permanently.</strong>{" "}
